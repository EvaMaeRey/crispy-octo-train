...
::: {focus-on="cr-PLOT2a"}
But, instead of using convenient `geom_bar()`, we can use the more generic `layer()` function - which is actually used under the hood to write all geom_ and stat_ functions.  
:::
