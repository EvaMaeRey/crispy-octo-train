...
subtitle: "a brief, gentle and whimsical first-look behind the curtains of ggplot2's layers"
...
Sidenote: Sometimes *all* the ggplot2 functions are referred to as ggplot2 layers scales\_\*(), coord\_\*(), etc. You often hear things like 'build up your plot layer-by-layer' but we are using the word in the narrower, original sense.
:::
